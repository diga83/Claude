/* ═══════════════════════════════════════════════════════════════════════════
   EDEXCEL GCSE (9-1) COMPUTER SCIENCE 1CP2 — DATA FILE
...
const CHAPTERS = [
  ...
  },
  {
    ...
    summary: "E-waste & energy, privacy & surveillance, AI & algorithmic bias, DPA 2018, Computer Misuse Act, copyright & licensing.",
    sections: 6
  },
  {
...
/* ═══════════════════════════════════════════════════════════════════════════
   GLOSSARY — 120+ terms across the 1CP2 specification
   ═══════════════════════════════════════════════════════════════════════════ */
...
const GLOSSARY = [
  ...
  {t:"Pseudocode", d:"A structured, language-neutral way of writing algorithms that resembles code but is not tied to any real language syntax.", ch:2},
  ...
  {t:"TCP/IP", d:"The protocol stack of the internet. Organised in four layers: application, transport, internet (network), link.", ch:9},
...
const QUIZ = {
  ...
  6: [
    {q:"How many bytes are in 1 kilobyte (KB) in the 1CP2 spec?", o:["1,000","1,024","8,000","100"], a:0, e:"Edexcel GCSE CS uses decimal units: 1 KB = 1,000 B; 1 MB = 1,000 KB; 1 GB = 1,000 MB."},
  ...
  9: [
    ...
    {q:"How many layers are in the TCP/IP model used by 1CP2?", o:["3","4","7","2"], a:1, e:"Four layers: application, transport, internet (network), link."},
